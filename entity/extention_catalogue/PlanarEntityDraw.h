 ...
 */
#ifndef MOJGAMELIB_ENTITY_EXTENTIONCATALOGUE_PLANARENTITYDRAW_H_
#define MOJGAMELIB_ENTITY_EXTENTIONCATALOGUE_PLANARENTITYDRAW_H_
...
#endif /* MOJGAMELIB_ENTITY_EXTENTIONCATALOGUE_PLANARENTITYDRAW_H_ */
